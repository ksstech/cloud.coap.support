...
function coapServer(logger, mongo, mqtt, coapClient){
    ...
    function route(data,res){
	      ...
	      if((data.payload === "" && data.confirm === true && data.method === undefined && data.url === '/') || (data.method === 'GET' && data.url === '/ping')){
           ...
           if(data.method === 'GET' && data.url === '/ping') res.end();
	         postRegister(data.clientAddress,data.clientPort, function postRegisterCallback(err,resData){
                ...
                mongo.registerMote(data.clientAddress, data.clientPort, resData, function registerMoteCallback(err, mote){
        ...
        else if(data.payload != "" && data.confirm === false && data.method === undefined && data.url === '/') {
          logger.info('sense data' + data.payload);
        }
    }
