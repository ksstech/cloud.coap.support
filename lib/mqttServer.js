...
mqttServer.prototype.publishSense = function publishSense(data){
    this.msgr.publish('disona/sense',JSON.stringify(data));
    this.logger.info('MQTT: Publish: disona/sense: '+  JSON.stringify(data));
};
