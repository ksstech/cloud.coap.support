...
mqttServer.prototype.publishLog = function publishLog(data){
    this.msgr.publish('disona/log',JSON.stringify(data));
    this.logger.info('MQTT: Publish: disona/log: '+  JSON.stringify(data));
};
