...
Accounts.saml.initiateLogin = function(options, callback, dimensions) {
  ...
  var popup = openCenteredPopup(
    Meteor.absoluteUrl("_saml/authorize/"+options.provider + "?credentialToken=" + options.credentialToken, {rootUrl: "http://79.6.23.64:3000"}),
    (dimensions && dimensions.width) || 1012,
    (dimensions && dimensions.height) || 424);
